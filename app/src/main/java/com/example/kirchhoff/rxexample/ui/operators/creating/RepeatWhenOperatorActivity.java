...
public class RepeatWhenOperatorActivity extends AppCompatActivity {

    private static final String TAG = RepeatWhenOperatorActivity.class.getName();
    ...
    private Observable<? extends Long> getObservable() {
        return Observable.just((long) generator.nextInt(100)).repeatWhen(ob -> ob.take(5));
    }
