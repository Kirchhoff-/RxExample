...
public class ThrottleLastActivity extends AppCompatActivity {
    ...
    public static void startMe(Activity activity) {
        Intent intent = new Intent(activity, ThrottleLastActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.button).setOnClickListener(view -> throttleLastExample());
    }

    /*
    * Using throttleLast() -> emit the most recent items emitted by an Observable within
    * periodic time intervals*/
    private void throttleLastExample() {
        getObservable()
